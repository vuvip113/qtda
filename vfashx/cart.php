        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (!isset($_SESSION['cart_p_id'])) : ?>
                    <?php echo '<h2 class="text-center">Cart is Empty!! <div> <lord-icon src="https://cdn.lordicon.com/dnoiydox.json" trigger="loop" colors="primary:#000000,secondary:#000000" stroke="60" style="width:100px;height:100px">
                    </lord-icon></div> </h2>'; ?>
