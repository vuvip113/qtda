...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 15, 2023 lúc 09:19 PM
...
(12, 103, 'new Fashx', 'XS', 'White', '1', '100000', '1681584344'),
(13, 103, 'new Fashx', 'XS', 'White', '1', '100000', '1681584991'),
(14, 104, 'Muzik heals my soul', 'XS', 'Blue', '1', '230000', '1681585117');
...
(67, 12, 'Petter', 'vucute775@gmail.com', '2023-04-15 11:45:44', '', 100000, '', '', '', '', '', 'PayPal', 'Pending', 'Pending', '1681584344'),
(68, 12, 'Petter', 'vucute775@gmail.com', '2023-04-15 11:56:31', '', 4167, '', '', '', '', '', 'PayPal', 'Pending', 'Pending', '1681584991'),
(69, 12, 'Petter', 'vucute775@gmail.com', '2023-04-15 11:58:37', '', 10, '', '', '', '', '', 'PayPal', 'Pending', 'Pending', '1681585117');
...
CREATE TABLE `tbl_product` (
  ...
  `p_old_price` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_current_price` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_qty` int(10) NOT NULL,
  `p_featured_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_short_description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_feature` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `p_return_policy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(12, 'Secure Checkout', 'Our security is assured with the latest encryption and certification.', 'service-12.png'),
(13, 'Free Shipping', 'Enjoy free shipping inside Viet Nam.', 'service-13.png'),
(14, 'Money Back Guarantee', 'Offer money back guarantee on our products', 'service-14.png');
...
(1, 'slider-1.jpg', 'Welcome to Vfashx', 'Make you look better to the best', 'View Our Shop', 'product-category.php?id=1&type=top-category', 'Center'),
...
(4, 'slider-4.jpg', '50% Discount on All Products', 'Lorem ipsum dolor sit amet, an labores explicari qui, eu nostrum copiosae argumentum has.', 'Buy Now', '#', 'Center');
